...
This log was last generated on Fri, 28 Jul 2023 05:59:15 GMT and should not be manually modified.
...
- update @modern-js/swc-plugins 0.5.2
...
- update @modern-js/swc-plugins 0.5.0
...
- support useDefineForClassFields option
...
- enable lodash optimization by default
...
- bump version 0.12.2
- bump @modern-js/swc-plugins to v0.3.3
...
- add swc-transform plugin, optimize umd-plugin, rename original transform-plugin, add `@deprecated` comment
...
- upgrade @modern-js/swc-plugins to 0.2.0
...
- export @modern-js/swc-plugins type
